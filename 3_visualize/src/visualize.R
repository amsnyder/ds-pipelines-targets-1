#' Create a plot
#' @param data data table to pull model results from
#' @param out_filepath string file path under which to save plot (in out dir)

make_plot <- function(data, out_filepath){
